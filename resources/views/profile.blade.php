...
<head>
    ...
    <title>Binayak Pokhrel | Facebook</title>
</head>
<body>
    <div class="header">
      ...
      <div class="upper">
          <div class="image">
            ...
            <div class="button">
                ...
                <button type="button"  style="cursor: pointer;"><i class="fa-solid fa-camera"></i> Add Cover Photo</button>
      ...
      <div class="lower">
                ...
                <!-- Modal -->
                    <div class="modal fade" id="profilepic" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <button type="button" class="btn btn-primary update_profile">Update Photo</button>
                            </div>
                        </div>
                        </div>
                    </div>
          ...
          <div class="profile_name">
              ...
              <div class="images_of_friends">
                  ...
                  <div class="buttons">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#story"><i class="fa-solid fa-circle-plus"></i> Add to Story</button>
                    ...
                    <button class="btn edit_button" data-bs-toggle="modal" data-bs-target="#cover_update"><i class="fa-solid fa-pen"></i> Edit Profile</button>


                     {{-- add cover photo starts --}}
                <!-- Modal -->
                    <div class="modal fade" id="cover_update" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-footer">
                            <label for="coverpic" class="btn  btn-success">Select Image</label>
      ...
      <div class="flex" style="display:flex;">
        ...
        <div class="right_intro" style="flex:2;">
            <div class="images">
                ...
                <button>What's on your mind,Binayak?</button>
            </div>
