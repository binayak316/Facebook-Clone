...
<body>
    <div class="header">
        <div class="header_left">
          <a href="{{route('authCheck')}}">  <img src="images/fb-logo.png" alt="logo of facebook"></a>
        ...
        <div class="header_middle">
            <div class="header_option active">
               <a href="{{route('authCheck')}}"> <svg viewBox="0 0 28 28" class="a8c37x1j ms05siws l3qrxjdp b7h9ocf4 py1f6qlh" fill="currentColor" height="35" width="35"><path d="M17.5 23.979 21.25 23.979C21.386 23.979 21.5 23.864 21.5 23.729L21.5 13.979C21.5 13.427 21.949 12.979 22.5 12.979L24.33 12.979 14.017 4.046 3.672 12.979 5.5 12.979C6.052 12.979 6.5 13.427 6.5 13.979L6.5 23.729C6.5 23.864 6.615 23.979 6.75 23.979L10.5 23.979 10.5 17.729C10.5 17.04 11.061 16.479 11.75 16.479L16.25 16.479C16.939 16.479 17.5 17.04 17.5 17.729L17.5 23.979ZM21.25 25.479 17 25.479C16.448 25.479 16 25.031 16 24.479L16 18.327C16 18.135 15.844 17.979 15.652 17.979L12.348 17.979C12.156 17.979 12 18.135 12 18.327L12 24.479C12 25.031 11.552 25.479 11 25.479L6.75 25.479C5.784 25.479 5 24.695 5 23.729L5 14.479 3.069 14.479C2.567 14.479 2.079 14.215 1.868 13.759 1.63 13.245 1.757 12.658 2.175 12.29L13.001 2.912C13.248 2.675 13.608 2.527 13.989 2.521 14.392 2.527 14.753 2.675 15.027 2.937L25.821 12.286C25.823 12.288 25.824 12.289 25.825 12.29 26.244 12.658 26.371 13.245 26.133 13.759 25.921 14.215 25.434 14.479 24.931 14.479L23 14.479 23 23.729C23 24.695 22.217 25.479 21.25 25.479Z"></path></svg></a>
            </div>
    ...
    <div class="container" style="width: 60%;">
      ...
      <div class="lower">
            <div class="images" id="image_id">
                ...
                <form  method="post" action="{{route('profile_posted')}}"  enctype="multipart/form-data">
                    ...
                    <div class="modal fade" id="profilepic" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" >
                                <div class="photo_preview" id="preview_profile">
                                    {{-- <img src="images/pp.jpg" alt="update photo"> --}}
                ...
                {{-- modals of profile picture update ends from here --}}

          
          <div class="profile_name">
              <h3 style="text-transform: capitalize;">{{auth()->user()->fname}} {{auth()->user()->lname}}</h3>
              <h5>197 friends</h5>
              <div class="images_of_friends">
                
                  <img src="images/pp.jpg" alt="friends photos" style="border-radius: 50%; height:45px;width:45px;border:3px solid white;" >
                  <img src="images/pp.jpg" alt="friends photos" style="border-radius: 50%; height:45px;width:45px;margin-left:-10px;border:3px solid white;" >
                  <img src="images/pp.jpg" alt="friends photos" style="border-radius: 50%; height:45px;width:45px;margin-left:-10px;border:3px solid white;" >
                  <img src="images/pp.jpg" alt="friends photos" style="border-radius: 50%; height:45px;width:45px;margin-left:-10px;border:3px solid white;" >
                  <img src="images/pp.jpg" alt="friends photos" style="border-radius: 50%; height:45px;width:45px;margin-left:-10px;border:3px solid white;" >
                  <img src="images/pp.jpg" alt="friends photos" style="border-radius: 50%; height:45px;width:45px;margin-left:-10px;border:3px solid white;" >
                  ...
                  <div class="buttons">
                    <button class="btn btn-primary" ><i class="fa-solid fa-circle-plus"></i> Add to Story</button>                  
                    <button class="btn edit_button" ><i class="fa-solid fa-pen"></i> Edit Profile</button>
                  </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="uploadphoto">
                                        <button type="submit"><i data-visualcompletion="css-img" class="hu5pjgll lzf7d6o1" style="background-image: url(&quot;https://static.xx.fbcdn.net/rsrc.php/v3/y0/r/q4V1uK1A1j8.png&quot;); background-position: 0px -83px; background-size: 33px 138px; width: 20px; height: 20px; background-repeat: no-repeat; display: inline-block;"></i>&nbsp;Upload Photo</button>
                                    </div>
...
function previewImages() {
    var preview = document.querySelector('#Cover_Image');
    ...
    document.querySelector('#select_cover_image').addEventListener("change", previewImages);
